...
public class AddReviewDialog {
    ...
    public void setComment(String comment) {
        String selector = "#add-review-comment";
    ...
    public void addImage(String imagePath) {
        WebElement imageUpload = driver.findElement(By.cssSelector("#review-images-upload input[type=\"file\"]"));
